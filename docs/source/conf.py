...
myst_html_meta = {
    "description": "FraudLabs Pro Go SDK is used by users to screen the order transaction for payment fraud.",
    "keywords": "FraudLabs Pro, Fraud Prevention, Fraud Detection, Go",
...
html_title = "FraudLabs Pro Go"

# html_baseurl = "https://fraudlabspro-go.readthedocs.io/en/latest/"