# FraudLabs Pro Go API

## Configuration Class

```{py:function} OpenConfiguration(apikey)
Configuration registry. Set the FraudLabs Pro API key.

:param string apikey: (Required) The FraudLabs Pro API key.
:return: Returns the configuration in object.
:rtype: object
```

## Order Class
```{py:function} OpenOrder(config)
Initiate Order class with FraudLabs Pro API key.

:param Configuration config: (Required) The Configuration object returned by OpenConfiguration.
```
...
| -------------- | -------------- | ------------------------------------------------------------ |
| id            | string         | FraudLabs Pro transaction ID.                    |

:return: Returns the details about the transaction in a map object.
:rtype: Object
...
Approve, reject or blacklist a transaction.

:param array params: (Required) The parameters of order details.

| Parameter    | Type    | Description |
|--------------|---------|---------------------|
| id          | string  | (required) Unique transaction Id generated by Validate function. |
...
Retrieve fraud screening information for an order.
...
:return: Returns the fraud screening information in a map. Refer below table for the fields avaliable in the map
:rtype: dictionary
...
```{py:function} OpenSmsVerification(config)
...
## Payment Class
```{py:function} OpenPayment(config)
